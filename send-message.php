...
<html>
	...
	<body>
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1><a href="user.php">Welcome <?php echo $name;echo $id; ?></a></h1>
					<nav id="nav">
						<ul>
				...
				<section id="main" class="container">
					<div class="row">
						<div class="12u">
							...
							<!--Form -->
								<section class="box">
									<h3>SMS Send message to the members</h3>
									<form method="post" action="message-process.php">
...
while( $row = mysqli_fetch_assoc($result) ){
          ...
          echo "<option value='".$row['mid']."'>". $row['mname_to'] ."</option>" ;
