				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="request-article.php" class="button">request</a></li>
...
<section class="box">
									...
									<h3><?php echo $name;echo $uid; ?> you can view Article in the Privacy Preserving</h3>
