				...
				<section id="main" class="container">
					<div class="row">
						<div class="12u">
							...
							<!--Form -->
								<section class="box">
									<h3>Please Provide us with user Key</h3>
									<form method="post" action="message-view.php">
										<div class="row uniform 50%">
											<div class="6u 12u(mobilep)">
												<input type="text" name="keys" id="keys" value="" placeholder="Please enter the Keys" />
											</div>
