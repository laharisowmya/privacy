				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="myrequest.php" class="button">My request</a></li>
				...
				<section id="main" class="container">
					<div class="row">
						<div class="12u">
							...
							<!--Form -->
								<section class="box">
									<h3>Your Request in Privacy Preserving</h3>
...
$sql = " SELECT * FROM request WHERE raisedby = '$name'   ";
...
while( $row = mysqli_fetch_assoc($result) ){
	...
	{
			echo "<td> <a href='approved-article.php?id=". $row['atitle'] ."'> Approved </a></td>";
	}
	else
	{
			echo "<td>Rejected</td>";
